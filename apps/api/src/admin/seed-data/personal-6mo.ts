...
export const PERSONAL_6MO: SeedTransaction[] = [
  ...
  // April 2026
  { date: '2026-04-01', description: 'EMPLOYER SALARY DEPOSIT',    amount:  4250.00 },
  { date: '2026-04-02', description: 'SOBEYS GROCERIES',           amount:  -198.30 },
  { date: '2026-04-03', description: 'NETFLIX STREAMING',          amount:   -15.99 },
  { date: '2026-04-05', description: 'ENBRIDGE GAS',               amount:   -89.40 },
  { date: '2026-04-07', description: 'PETRO CANADA GAS STATION',   amount:   -74.60 },
  { date: '2026-04-10', description: 'YMCA MEMBERSHIP',            amount:   -56.00 },
  { date: '2026-04-12', description: 'TD VISA PAYMENT',            amount:  -700.00 },
  { date: '2026-04-14', description: 'WALMART GENERAL',            amount:  -132.45 },
  { date: '2026-04-15', description: 'INVESTMENT INCOME DIVIDEND', amount:    56.02 },
  { date: '2026-04-18', description: 'SHOPPERS DRUG MART',         amount:   -48.90 },
  { date: '2026-04-22', description: 'INTACT INSURANCE',           amount:  -300.00 },
  { date: '2026-04-25', description: 'HYDRO ONE ELECTRICITY',      amount:  -108.60 },
  { date: '2026-04-28', description: 'RESTAURANTS CANADA DINNER',  amount:   -94.20 },
  { date: '2026-04-30', description: 'CST SAVINGS TRANSFER',       amount:  -200.00 },
];
