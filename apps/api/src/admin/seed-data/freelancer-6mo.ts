...
export const FREELANCER_6MO: SeedTransaction[] = [
  ...
  // April 2026
  { date: '2026-04-01', description: 'EMPLOYER DIRECT DEPOSIT',           amount:  2610.24 },
  { date: '2026-04-03', description: 'NETFLIX STREAMING',                 amount:   -15.99 },
  { date: '2026-04-05', description: 'CONSULTING INVOICE INV-007',        amount:  2750.00 },
  { date: '2026-04-07', description: 'ROGERS WIRELESS',                   amount:   -78.50 },
  { date: '2026-04-08', description: 'SHOPIFY SUBSCRIPTION',              amount:   -39.00 },
  { date: '2026-04-10', description: 'AUDIBLE SUBSCRIPTION',              amount:   -15.70 },
  { date: '2026-04-12', description: 'HOME OFFICE SUPPLIES STAPLES',      amount:   -94.20 },
  { date: '2026-04-14', description: 'CLIENT RETAINER PAYMENT',           amount:   950.00 },
  { date: '2026-04-15', description: 'MICROSOFT 365 SUBSCRIPTION',        amount:   -22.00 },
  { date: '2026-04-18', description: 'FORESTERS LIFE INS',                amount:   -42.58 },
  { date: '2026-04-20', description: 'YOUTUBE PREMIUM',                   amount:   -12.99 },
  { date: '2026-04-22', description: 'CLIENT MEETING LUNCH SYMPOSIUM',    amount:   -71.40 },
  { date: '2026-04-25', description: 'PROFESSIONAL DEVELOPMENT COURSERA', amount:   -49.00 },
  { date: '2026-04-28', description: 'UBER EATS TORONTO',                 amount:   -38.90 },
  { date: '2026-04-30', description: 'CST SAVINGS REP',                   amount:   -50.00 },
];
