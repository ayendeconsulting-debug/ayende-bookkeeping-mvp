...
export function TaxCodesManager({ initialTaxCodes, taxAccounts }: TaxCodesManagerProps) {
  ...
  async function handleDeactivate(id: string) {
    const result = await deactivateTaxCode(id);
    if (result.success) {
      setTaxCodes((prev) => prev.map((c) => (c.id === id ? { ...c, is_active: false } : c)));
    }
  }
  ...
  return (
    <div className="p-6 max-w-screen-lg mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Manage GST, HST, PST and other tax rates
          </p>
        </div>
      ...
      {/* Common Canadian tax codes hint */}
      {taxCodes.length === 0 && (
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  This tax code will be deactivated. Existing tax transactions
                                  are not affected.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
