...
async function getDetections(): Promise<RecurringDetectionCandidate[]> {
  try {
    return await apiGet<RecurringDetectionCandidate[]>('/personal/recurring-detections');
  } catch {
    return [];
  }
}
...
async function getConfirmed(): Promise<ConfirmedRecurring[]> {
  try {
    return await apiGet<ConfirmedRecurring[]>('/personal/recurring-confirmed');
  } catch {
    return [];
  }
}
    ...
    <div className="p-6 max-w-screen-lg mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          Detected subscriptions and bills from your transaction history.
        </p>
      </div>
