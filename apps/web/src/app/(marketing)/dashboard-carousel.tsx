      ...
      <div className="p-5 bg-[#f5f3ef] dark:bg-[#1a1714]">
        <div className="bg-card rounded-xl overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            {[
              { bank: 'TD Canada Trust', account: 'Business Chequing ••4821', balance: '$24,150', status: 'Synced', color: '#0F6E56' },
              { bank: 'RBC Royal Bank',  account: 'Business Savings ••3302',  balance: '$18,400', status: 'Synced', color: '#0F6E56' },
              { bank: 'Visa Business',   account: 'Credit Card ••7719',        balance: '-$3,280', status: 'Synced', color: '#185FA5' },
            ].map((acc) => (
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex justify-start">
              <div className="bg-muted text-foreground text-xs px-3 py-2 rounded-xl rounded-tl-sm max-w-[85%] leading-relaxed">
                Your Q1 net profit margin was <strong>34.1%</strong> — net income of $16,480 on revenue of $48,320. This is up from 29.8% in Q4 2025, driven by lower software costs and higher consulting revenue.
              </div>
            </div>
            <div className="flex justify-end">
              <div className="bg-[#0F6E56] text-white text-xs px-3 py-2 rounded-xl rounded-tr-sm max-w-[80%]">
