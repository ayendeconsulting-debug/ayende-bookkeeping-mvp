...
export function RequestDemoButton({
  ...
  const inputCls = 'w-full text-sm border border-gray-200 rounded-lg px-3 py-2 outline-none focus:border-[#0F6E56] focus:ring-1 focus:ring-[#0F6E56]';
      ...
      {open && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            {/* Header */}
            <div className="bg-[#0F6E56] px-6 py-5 flex-shrink-0">
            ...
            {/* Accent stripe */}
            <div className="h-0.5 bg-gradient-to-r from-[#5ECBA1] via-[#C3E8D8] to-[#EDF7F2] flex-shrink-0" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      placeholder="Tell us about your bookkeeping needs, team size, or anything that would help us prepare..."
                      rows={3}
